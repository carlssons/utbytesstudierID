      ...
      process: [
        {
          ...
          info:
            "Umeå universitet har olika avtal med partneruniversitet runt om i världen."
        },
        {
          icon: "diploma.svg",
          processHead: "2. Bli nominerad",
          info:
            "Ansök till Umeå universitet om att bli tilldelad en plats vid ett partneruniversitet."
        },
        {
          icon: "letter.svg",
