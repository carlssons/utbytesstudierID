      ...
      <div className="agreements">
        <div className="section-1">
          ...
          <div
            ...
            id="button-central"
            onClick={() => slideDownProcess("first")}
          >
            <p>
        ...
        <div className="section-2">
          ...
          <div
            className="button arrow-down"
            id="button-erasmus"
            onClick={() => slideDownProcess("second")}
          >
            <p>
              <b>Ansökningsprocess</b>
            </p>
